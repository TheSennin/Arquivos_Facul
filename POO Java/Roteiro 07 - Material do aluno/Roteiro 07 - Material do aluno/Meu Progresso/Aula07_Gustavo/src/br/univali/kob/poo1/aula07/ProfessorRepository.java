 ...
 */
public abstract class ProfessorRepository<T extends Person> extends Repository<Person> {
     ...
     */
    public ProfessorRepository(String fileName) throws IOException, ClassNotFoundException {
        super(fileName);
    }
