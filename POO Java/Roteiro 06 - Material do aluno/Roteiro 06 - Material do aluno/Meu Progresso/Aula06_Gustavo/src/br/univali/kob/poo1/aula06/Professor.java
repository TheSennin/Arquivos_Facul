...
public class Professor extends Employee {
     ...
     * @param hourlyRate
     */
    public Professor(String name, LocalDate dateOfBirth, String email, LocalDate hireDate, int hoursPerWorkWeek, BigDecimal hourlyRate, AcademicDegree academicDegree, LocalDate terminationDate) {
        super(name, dateOfBirth, email, hireDate, hoursPerWorkWeek, hourlyRate, terminationDate);
     ...
     */
    public Professor(String name, String dateOfBirth, String email, String hireDate, int hoursPerWorkWeek, String hourlyRate, AcademicDegree academicDegree, String terminationDate){
        super(name, dateOfBirth, email, hireDate, hoursPerWorkWeek, hourlyRate, terminationDate);
        setAcademicDegree(academicDegree);
    }
