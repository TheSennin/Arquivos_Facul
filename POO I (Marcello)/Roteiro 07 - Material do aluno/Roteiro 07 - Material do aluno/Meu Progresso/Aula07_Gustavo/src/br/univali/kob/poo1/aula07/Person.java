 ...
 *
 */
public abstract class Person implements Contactable, Serializable {
    ...
    public String toString(){
      ...
      output.append("E-mail = " + email + AppConfig.NEW_LINE);
    ...
    @Override
    public int hashCode(){
        return id ^ (name.hashCode()) ^ (dateOfBirth.hashCode() ^ (address.hashCode()));
    }
    ...
    /**
     * setter
     * @return a secure copy of address
     */
