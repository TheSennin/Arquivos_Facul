...
import br.univali.kob.poo1.aula06.Professor.AcademicDegree;
...
public class ContactBook {
    ...
    public String toString() {
        // Adaptado da geração do NetBeans. Ele segue basicamente a mesma 
        //estrututra, mas sem quebra
        // de linhas
        // ArrayList já tem um toString que chama o toString de seus elementos
        // Elementos ficam entre []
        return "ContactBook {" + AppConfig.NEW_LINE + "  CONTACTS = " + CONTACTS
                + AppConfig.NEW_LINE + '}';
    }
    ...
    public void sort(OrderBy orderBy) {
        CONTACTS.sort(orderBy == OrderBy.EMAIL ? NAME_ORDER : EMAIL_ORDER);
    }
...
class ContactBookLocalTest {
    ...
    public static void addContacts() {
        contactBook.add(new Employee("Orin Curry", "15/01/1976", "orin@com", "01/03/2000", 40, "22.80", null));
        contactBook.add(new Student(1, "Bruce Wayne", "02/05/1996", "wayne@com", "01/03/2017", "08/03/2020"));
        contactBook.add(new Professor("Stephen Vincent Strange", "23/06/1971", "strange@com", "05/08/1996", 40, "22.80", AcademicDegree.DOCTORATE, null));
        contactBook.add(new Student(2, "Emma Grace Frost", "23/09/1994", "frost@com", "31/07/2016", "08/03/2020"));
        contactBook.add(new Employee("Susan Kent-Barr", "06/10/1969", "susan@com", "09/08/1995", 40, "25.23", null));
