...
public class Employee extends Person {
    ...
    public Employee(String name, LocalDate dateOfBirth, String email, LocalDate hireDate, int hoursPerWorkWeek, BigDecimal hourlyRate, LocalDate terminationDate) {
     ...
     * @param terminationDate 
     */
    public Employee(String name, String dateOfBirth, String email, String hireDate, int hoursPerWorkWeek, String hourlyRate, String terminationDate){
        super(name, dateOfBirth, email);
